...
export default function StaffingSolutions() {
  return (
    <div className="staffing-page">
            ...
            <div className="col-lg-5">
              <div className="bg-white bg-opacity-10 rounded p-4 border border-light border-opacity-25">
                <ul className="list-unstyled mb-0">
                  ...
                  <li>
                    <strong>White Collar:</strong> Professional & leadership
                    hiring
                  </li>
                </ul>
              </div>
      ...
      {/* ================= BLUE COLLAR ================= */}
      <section className="py-5 bg-light px-md-5">
          ...
          <div className="row align-items-center mb-5">
            ...
            <div className="col-lg-6 ps-lg-5">
              <p className="fs-5 text-secondary">
                Building your workforce shouldn't be complicated. We deliver
                skilled, dependable blue-collar professionals to keep your
                projects moving — safely, efficiently, and on time.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="row align-items-center mb-5">
            ...
            <div className="col-lg-6 pe-lg-5 order-lg-1">
              ...
              <p className="fs-5 text-secondary">
                White collar roles demand not only skill but also leadership
                qualities, problem-solving ability, and cultural alignment. Our
                recruiters specialize in sourcing candidates who align with your
                organization’s goals and environment.
              </p>
            </div>
          </div>
          ...
          <div className="row g-4">
            {[
              ...
              },
              {
                ...
                text: "We assess skills, qualifications, and culture-fit for high retention.",
              },
              {
                icon: <FaRegClock />,
                title: "Faster Hiring",
              ...
              <div key={i} className="col-md-6 col-lg-4">
                <div className="h-100 p-4 border rounded bg-white shadow-sm text-center">
                  <div className="text-primary fs-2 mb-3 d-flex justify-content-center">{item.icon}</div>
                  <h6 className="fw-semibold">{item.title}</h6>
                  <p className="text-secondary small mb-0">{item.text}</p>
                </div>
              </div>
      ...
      {/* ================= GREY COLLAR ================= */}
      <section className="py-5 bg-light border-top px-md-5">
        <div className="container">
          <div className="text-center mb-5">
          ...
          <div className="row align-items-center mb-5">
            ...
            <div className="col-lg-6 ps-lg-5">
              ...
              <p className="fs-5 text-secondary ">
                These roles are critical for maintaining quality standards,
                coordinating teams, and ensuring that operational goals are met
                without delays or communication gaps.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                text: "Certified technicians, machine operators, and field engineers trained for modern operational environments.",
              },
              {
                icon: <FaUserCheck />,
                title: "Supervisory & Support Roles",
                text: "Experienced supervisors and coordinators who ensure productivity, safety, and quality compliance.",
              },
              {
                icon: <FaRegClock />,
                title: "Operational Continuity",
                text: "Reliable workforce that minimizes downtime and maintains seamless coordination between teams.",
              },
            ].map((item, i) => (
              <div key={i} className="col-md-6 col-lg-4">
                <div className="h-100 p-4 border rounded bg-white shadow-sm text-center">
